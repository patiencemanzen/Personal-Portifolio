    ...
    <div class="relative z-10 flex justify-start md:justify-center md:items-end 2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
        <div class="flex pt-20 border-t border-gray-800 dark:border-gray-200 flex-col justify-start items-start md:justify-center md:items-center relative z-10">
            <div class="flex flex-col items-start justify-start xl:justify-center xl:space-x-8 xl:flex-row">
                ...
                <div class="mt-12 xl:mt-0 grid grid-cols-1 sm:grid-cols-3 gap-y-12 sm:gap-y-0 w-full md:w-auto sm:gap-x-20 md:gap-x-28 xl:gap-8">
                    <div class="sm:w-40 md:w-auto xl:w-72 flex justify-start items-start flex-col space-y-6">
                        <h2 class="text-base xl:text-xl font-bold xl:font-semibold leading-4 xl:leading-5 text-black dark:text-white">Technologies</h2>
                        <button class="text-left text-base hover:text-gray-400 leading-none text-gray-400 dark:text-gray-200">
                            PHP: Hypertext Preprocessor
                        </button>
                        <button class="text-left text-base hover:text-gray-400 leading-none text-gray-400 dark:text-gray-200">
                            Javascript: Client-side pro language
                        </button>
                    </div>

                    <div class="sm:w-40 md:w-auto xl:w-72 flex justify-start items-start flex-col space-y-6">
                        <h2 class="text-base xl:text-xl font-bold xl:font-semibold leading-4 xl:leading-5 text-black dark:text-white">Specialized</h2>
                        <button class="text-left text-base hover:text-gray-400 leading-none text-gray-400 dark:text-gray-200">
                    ...
                    <div class=" xl:w-72 flex justify-start items-start flex-col space-y-6">
                        <h2 class="text-base xl:text-xl font-bold xl:font-semibold leading-4 xl:leading-5 text-black dark:text-white">Resources</h2>
                        <button class="text-base text-left hover:text-gray-400 leading-none text-gray-400 dark:text-gray-200">
                            Accessibility
                        </button>
                        <button class="text-base text-left hover:text-gray-400 leading-none text-gray-400 dark:text-gray-200">
                            Usability
            ...
            <div id="revue-embed" class="p-4 my-8 mt-1 bg-white rounded-lg border border-gray-200 shadow-md sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700">
                ...
                <p class="mb-5 text-sm font-medium text-gray-500 dark:text-gray-300">
                    Do you want to get notified when a new blog is added?
                    Sign up for our newsletter and you'll be among the first to
                    find out about new features, blogs, articles, and projects.
                </p>

                <form wire:submit.prevent="subscribe" method="post" id="revue-form" name="revue-form">
                    <div class="flex items-end mb-3">
                        <div class="relative mr-3 w-full revue-form-group">
                            ...
                            <input wire:model="email" class="revue-form-field bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your email address..." type="email" name="email" id="member_email" required="">
                        ...
                        <div class="relative mr-3 w-full revue-form-group">
                            ...
                            <input wire:model="fullname" class="revue-form-field bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your Fullname" type="text" name="fullname" id="member_fullname" required="">
                            @error('fullname') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="revue-form-actions">
                            <input wire:click="subscribe" type="submit" value="Subscribe" class="cursor-pointer text-white hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" name="member[subscribe]" id="member_submit" style="background: #aec083">
                        </div>
                    </div>

                    <div class="text-sm font-medium text-gray-500 revue-form-footer dark:text-gray-300">
                        By subscribing, you agree with PatienceMan's
                        <a rel="nofollow" href="https://www.getrevue.co/terms" class="text-blue-600 hover:underline dark:text-blue-500">Terms of Service</a>
                        and
                        <a rel="nofollow" class="text-blue-600 hover:underline dark:text-blue-500" href="https://www.getrevue.co/privacy">Privacy Policy</a>.
                    </div>
                </form>
            </div>

            <div class="h-10 md:h-20"></div>
            <div class="flex  xl:justify-between xl:flex-row flex-col-reverse items-center xl:items-start w-full ">
                <p class="mt-10 md:mt-12 xl:mt-0 text-sm leading-none text-black dark:text-white" >
                    2022 Patience Manirabona. All Rights Reserved
                </p>
                <div class="mt-10 md:mt-12 xl:mt-0 md:flex-row flex-col flex md:justify-center w-full md:w-auto justify-start items-start space-y-4 md:space-y-0 md:items-center md:space-x-4 xl:space-x-6">
                    <button class="text-base leading-none text-gray-800 dark:text-gray-200 hover:text-gray-300">
                        Terms of service
                    </button>
                    <button class="text-base leading-none text-gray-800 dark:text-gray-200 hover:text-gray-300">
                        Privacy Policy
                ...
                <div class="flex  justify-start md:justify-end items-start  w-full md:w-auto md:items-center space-x-6 ">
                    <a href="https://twitter.com/ManirabonaW" class="text-gray-800 dark:text-gray-200 hover:text-gray-200 w-6">
                    ...
                    <a  href="https://www.facebook.com/nolanil.manirabona" class="text-gray-800 dark:text-gray-200 hover:text-gray-200 w-6">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://github.com/manirabona-programer" class="text-gray-800 dark:text-gray-200 hover:text-gray-200 w-6">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
