<div
    ...
    <div class="grid gap-8 md:grid-cols-2 mt-5">
        ...
        <div>
            <div class="-mr-24 rounded-lg md:rounded-l-full bg-gradient-to-br from-gray-900 to-black h-96"
                style="background-image: url(https://cdn.99images.com/photos/wallpapers/artist/artist%20android-iphone-desktop-hd-backgrounds-wallpapers-1080p-4k-vyqif.jpg)">
    ...
    <div class="grid gap-4 md:grid-cols-3 mb-5">
        <a href="https://norldverse.netlify.app/">
        ...
        <a href="https://www.vitaway.org">
            <div class="flex-col p-8 py-16 rounded-lg shadow-2xl md:p-12 bg-gradient-to-b from-gray-900 to-black"
                style="background: linear-gradient(to bottom, rgba(0, 0, 0, 0.1), rgba(117, 19, 93, 0.73)), url(https://c4.wallpaperflare.com/wallpaper/759/35/768/cyberpunk-science-fiction-futuristic-city-wallpaper-preview.jpg) no-repeat; background-size:cover;">
                <p
        ...
        <a href="https://vitaway-account.vercel.app">
            <div class="flex-col p-8 py-16 rounded-lg shadow-2xl md:p-12 bg-gradient-to-bl from-gray-900 to-black"
                style="background: linear-gradient(to bottom, rgba(0, 0, 0, 0.1), rgba(117, 19, 93, 0.73)), url(https://c4.wallpaperflare.com/wallpaper/119/301/279/future-city-science-fiction-sunrise-wallpaper-preview.jpg) no-repeat; background-size:cover;">
                <p
