<div class="2xl:container 2xl:mx-auto border border-gray-200 border-b-0 border-x-0 lg:py-16 lg:px-20 md:py-12 md:px-6 sm:py-5 sm:px-6 py-9 px-4 pt-32 items-center relative z-10 container mx-auto"
    ...
    <div class="hang-astro absolute right-20" style="top: 15rem">
        <div class="parent">
            <div class="card">
                <div class="glass"></div>
                <div class="content">
