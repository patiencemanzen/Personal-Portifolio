<div class="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 pt-32 items-center relative z-10 container mx-auto">
    ...
    <div class="lg:mt-14 sm:mt-10 mt-12">
        <img class="lg:block hidden w-full rounded-md object-cover h-64 object-scale-up" src="https://www.vitaway.org/patienceman-images/events.png" alt="Manirabona Patience in Google developer Kigali DevFest" />
        <img class="lg:hidden sm:block hidden w-full object-cover h-64 object-scale-up" src="https://www.vitaway.org/patienceman-images/events.png" alt="Manirabona Patience in Google developer Kigali DevFest" />
        <img class="sm:hidden block w-full object-cover h-64 object-scale-up" src="https://www.vitaway.org/patienceman-images/events.png" alt="Manirabona Patience in Google developer Kigali DevFest" />
    </div>
</div>
