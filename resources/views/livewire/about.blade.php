<div class="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 sm:py-3 sm:px-6 py-9 px-4 pt-32 items-center relative z-10 container mx-auto my-10">
    <div class="lg:w-10/12 w-full">
        ...
        <h2 class="xl:w-8/12 lg:w-10/12 w-full font-bold text-gray-800 dark:text-white lg:text-5xl text-4xl  leading-10 mt-5">
            I'm just one heck of a skilled backend developer guy,
        </h2>
        <p class="font-normal text-gray-600 dark:text-white mt-6 text-2xl leading-8">
            with three years of experience in Laravel and Node.js. In addition, I have two and a half years of expertise in
            frontend development using React, Vue, and TypeScript. but also, I am an emotional, stubborn, simple and romantic
            individual who prefers small groups to socializing with large ones.
        </p>
    </div>
</div>
