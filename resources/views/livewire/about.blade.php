<div class="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 pt-32 items-center relative z-10 container mx-auto">
    <div class="lg:w-10/12 w-full">
        <p class="font-bold mb-2 text-md leading-3 text-black-700 dark:text-indigo-500 hover:text-indigo-800 cursor-pointer">About me!</p>
        ...
        <p class="font-normal text-base leading-6 text-gray-600 dark:text-white mt-6" style="font-family: 'Anek Telugu', sans-serif !important; font-weight: 500; font-size: 20px">
    ...
    <div class="lg:mt-14 sm:mt-10 mt-12">
        <img class="lg:block hidden w-full rounded-md object-cover" style="width: 100%; height:500px;" src="https://res.cloudinary.com/dzhuhtn30/image/upload/v1671444600/20221003_132245_tsgock.png" alt="Manirabona Patience in Google developer Kigali DevFest" />
        <img class="lg:hidden sm:block hidden w-fullw-full rounded-md object-cover" style="width: 100%; height:500px;" src="https://res.cloudinary.com/dzhuhtn30/image/upload/v1671444600/20221003_132245_tsgock.png" alt="Manirabona Patience in Google developer Kigali DevFest" />
        <img class="sm:hidden block w-fullw-full rounded-md object-cover" style="width: 100%; height:500px;" src="https://res.cloudinary.com/dzhuhtn30/image/upload/v1671444600/20221003_132245_tsgock.png" alt="Manirabona Patience in Google developer Kigali DevFest" />
    </div>
</div>
