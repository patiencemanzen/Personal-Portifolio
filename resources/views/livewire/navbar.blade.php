            ...
            <div class="flex items-center">
                ...
                <div class="flex justify-between items-center">
                  <a href="/" class="flex" data-tooltip-target="tooltip-logo-1">
                    ...
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white ml-4">PatienceMan</span>
                  </a>
              ...
              <div class="flex items-center">
                <ul id="flowbiteMenu" class="hidden flex-col pt-6 lg:flex-row lg:self-center lg:py-0 lg:flex">
                  <li class="mb-3 lg:px-2 xl:px-3 lg:mb-0">
                    <a href="/docs/getting-started/quickstart/" data-tooltip-target="tooltip-twitter" class="text-sm font-medium text-gray-900 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-500">Twitter</a>
                  ...
                  <li class="mb-3 lg:px-2 xl:px-3 lg:mb-0">
                    <a href="/blocks/" data-tooltip-target="tooltip-facebook" class="text-sm font-medium text-gray-900 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-500">Facebook</a>
                  ...
                  <li class="mb-3 lg:px-2 xl:px-3 lg:mb-0">
                    <a href="/figma/" data-tooltip-target="tooltip-linkedin" class="text-sm font-medium text-gray-900 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-500">LinkedIn</a>
                  ...
                  <li class="mb-3 lg:px-2 xl:px-3 lg:mb-0">
                    <a href="/resources/" data-tooltip-target="tooltip-insta" class="text-sm font-medium text-gray-900 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-500">Instagram</a>
                  ...
                  <li class="mb-3 lg:px-2 xl:px-3 lg:mb-0">
                    <a href="/pro/" data-tooltip-target="tooltip-email" class="text-sm font-medium text-gray-900 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-500">Gmail</a>
                ...
                <a href="/pro/#pricing" class="md:hidden inline-flex items-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ml-3" style="background: #bfd291">Articles</a>
                <a href="/pro/#pricing" class="hidden md:inline-flex items-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ml-3" style="background: #bfd291">Blogs & Articles</a>
              </div>
        </div>
    </div>
  </header>
