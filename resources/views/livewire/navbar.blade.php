<div class="flex items-center justify-center">
    <div class="fixed px-4 flex-none w-[80vw] z-40 top-0 mt-5 bg-white/90 dark:border-gray-600 dark:bg-deep-green-800 border border-gray-200 backdrop-blur p-3 rounded-full">
                            ...
                            <div class="flex items-center">
                                <ul id="flowbiteMenu"
                                    ...
                                    <li class="lg:px-2 xl:px-3 lg:mb-0">
                                        <a target="_blank" href="https://blog.patienceman.com"
                                            data-tooltip-target="tooltip-blogs"
