<header class="sticky top-0 z-40 flex-none mx-auto w-full bg-white border-b border-gray-200 dark:border-gray-600 dark:bg-gray-800">
    ...
    <div class="py-3 px-3 mx-auto w-full max-w-8xl lg:px-4">
        <div class="conatiner flex justify-between items-center ">
            <div class="flex items-center">
                ...
                <div class="flex justify-between items-center">
                  <a href="/" class="flex">
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">PatienceMan</span>
                  </a>
                </div>
              </div>
              ...
              <div class="flex items-center">
                <ul id="flowbiteMenu" class="hidden flex-col pt-6 lg:flex-row lg:self-center lg:py-0 lg:flex">
                  <li class="mb-3 lg:px-2 xl:px-3 lg:mb-0">
                    <a href="/docs/getting-started/quickstart/" class="text-sm font-medium text-gray-900 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-500">Twitter</a>
                  </li>
                  <li class="mb-3 lg:px-2 xl:px-3 lg:mb-0">
                    <a href="/blocks/" class="text-sm font-medium text-gray-900 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-500">Facebook</a>
                  </li>
                  <li class="mb-3 lg:px-2 xl:px-3 lg:mb-0">
                    <a href="/figma/" class="text-sm font-medium text-gray-900 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-500">LinkedIn</a>
                  </li>
                  <li class="mb-3 lg:px-2 xl:px-3 lg:mb-0">
                    <a href="/resources/" class="text-sm font-medium text-gray-900 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-500">Instagram</a>
                  </li>
                  <li class="mb-3 lg:px-2 xl:px-3 lg:mb-0">
                    <a href="/pro/" class="text-sm font-medium text-gray-900 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-500">Gmail</a>
                  </li>
                </ul>
