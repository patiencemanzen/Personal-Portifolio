<div class="flex items-center justify-center">
    <div class="fixed px-4 flex-none w-[80vw] z-40 top-0 mt-5 bg-white/90 dark:border-gray-600 dark:bg-deep-green-800 border border-gray-200 backdrop-blur p-3 rounded-2xl">
        <div class="dark:bg-deep-green-800 px-4">
                ...
                <div class="flex items-center">
                    <ul id="flowbiteMenu"
                        ...
                        <li class="lg:px-2 xl:px-3 lg:mb-0">
                            <a target="_blank" href="https://norldverse.patienceman.com" data-tooltip-target="tooltip-blogs"
                    ...
                    <a href="https://github.com/manirabona-programer" target="_blank"
                    ...
                    <a href="https://hashnode.com/@Patienceman" target="_blank"
                        data-tooltip-target="tooltip-hashnode-2"
                        class="hidden sm:inline-block text-gray-500 dark:text-gray-400 dark:bg-gray-700 bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2 mr-1">
                    ...
                    <div id="tooltip-hashnode-2" role="tooltip"
                        class="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip"
                        data-popper-placement="top"
                        style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate(1186px, -64px);">
                    ...
                    <a href="https://linktr.ee/patienceman" target="_blank"
                        data-tooltip-target="tooltip-linktree-2"
                        class="hidden sm:inline-block text-gray-500 dark:text-gray-400 dark:bg-gray-700 bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2 mr-1">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    <div id="tooltip-linktree-2" role="tooltip"
                        class="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip"
                        data-popper-placement="top"
                        style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate(1186px, -64px);">
                        Check my links
